  ...
  return (
    <>
      <AppShell
        ...
        subtitle="Keep a personal list of custom workouts and add new ones whenever you want."
      >
        <Pressable
          style={({ pressed }) => [styles.addButton, styles.addButtonFullWidth, pressed && styles.addButtonPressed]}
          onPress={openCreateModal}
        >
          <Text style={styles.addButtonText}>
            {isLoading ? 'Add Custom Workout' : `Add Custom Workout`}
          </Text>
        </Pressable>

        <View style={styles.listSection}>
          <Text style={styles.sectionLabel}>Your custom workouts</Text>
          ...
          >
            {sortedWorkouts.length ? (
              sortedWorkouts.map((workout) => {
                const workoutDetails = buildWorkoutDetails(workout)
                ...
                return (
                  <View key={workout.id} style={styles.workoutCard}>
                    ...
                    {workoutDetails.length ? (
                      <Text style={styles.workoutMeta}>{workoutDetails.join('  •  ')}</Text>
                    ) : (
                      <Text style={styles.workoutMetaMuted}>No optional details added yet.</Text>
                    )}

                    <Text style={styles.workoutDescription}>
                      {workout.description.trim() || 'No description added yet.'}
                    </Text>
                  </View>
                )
              })
              ...
              <View style={styles.emptyState}>
                ...
                <Text style={styles.emptyBody}>
                  Build your first workout with the button above. Only the title is required.
                </Text>
              </View>
            )}
          </ScrollView>
            ...
            <View style={styles.modalCard}>
              ...
              >
                ...
                <Text style={styles.modalSubtitle}>
                  Add a title, choose a category, and fill in any optional details you want.
                </Text>
